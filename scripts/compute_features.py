...
META = set("""слово вопрос замена заменить цитата икс игрек зет материал раздаточный раздача чтец
раздатка раздатки раздатке раздатку раздаткой раздаток раздаткам раздатками раздатках раздатко
раздачи раздаче раздачу раздачей раздач раздачам раздачами раздачах
раздаточныи раздаточныйматериал
...
def lemma(w):
    ...
    if v is None:
        ...
        if p.is_known:
            ...
            # иначе оставляем слово (иначе pymorphy выдумывает лемму).
